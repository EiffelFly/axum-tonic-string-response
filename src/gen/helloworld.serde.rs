...
impl<'de> serde::Deserialize<'de> for HelloRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct helloworld.HelloRequest")
            }
        ...
        deserializer.deserialize_struct("helloworld.HelloRequest", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for HelloResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct helloworld.HelloResponse")
            }
        ...
        deserializer.deserialize_struct("helloworld.HelloResponse", FIELDS, GeneratedVisitor)
    }
}
